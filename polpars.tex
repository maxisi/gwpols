...
%
%
In this work, the exposition is geared towards observers, or theorists interested in drawing connections to observation---as such, it aims for pragmatism, rather than elegance, and, in particular, it does not cover formal aspects that connect the treatment of GW polarizations to the mathematical structure of GR; such connections can be found elsewhere by following the references.
...
Having established the importance of elliptical (fully polarized) modes, Sec.~\ref{sec:ellip} examines their key properties, sketching their connection to spin-weighted spherical harmonics.
Next, Sec.~\ref{sec:angles} carefully examines the different notions of ``polarization angle'' that arise for elliptical and nonelliptical signals, elucidating their connection. 
...
Finally, Sec.~\ref{sec:nongr} briefly covers generalizations to beyond-GR polarization states.
