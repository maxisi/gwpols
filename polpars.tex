...
At any given time, interpret Eq.~\eqref{eq:Aphi} as the real parts of two complex numbers with magnitudes $A_{+/\times}$ and arguments $\omega t - \phi_{+/\times}$.
Geometrically, this corresponds to vectors $\vec{A}_{+/\times}$ of magnitude $A_{+/\times}$, subtending angles $\omega t - \phi_{+/\times}$ with respect to the real axis.
