...
\Acp{GW} come in two distinct polarization states, which encode information about the structure of \ac{GR} and the dynamics of the source.
...
The abundance of conventions for the definition and parametrization of \ac{GW} polarizations extends from the descriptions in the literature to the implementations of actual data analysis pipelines.
...
As an example, these considerations come into play when parametrizing continuous \acp{GW} from galactic pulsars, and in relating such expected measurements to electromagnetic observations of the source orientation \cite{Isi:2017equ,Pitkin:2017qfy}.
...
This paper attempts to bridge the different treatments in the literature by providing a comprehensive exposition of the formalism underlying \ac{GW} polarizations and the different conventions used in parametrizing them.
The goal is twofold:
