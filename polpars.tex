...
\end{align}
\end{subequations}
The Jacobian factorizes into a factor of $1/A$, and a nontrivial function of $\epsilon$ and $\theta$.
...
Furthermore, the Jacobian diverges to positive infinity for $\epsilon = \pm 1$, meaning that circular polarizations will be disfavored in this scenario.
