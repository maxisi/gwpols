...
We point out that analyses parametrized directly in terms of the linear (plus and cross) modes tend to implicitly favor large signal amplitudes, and favor linearly-polarized waves along a predefined direction, which makes them suboptimal for targeting face-on or face-off sources.
\end{abstract}
