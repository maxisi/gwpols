...
\begin{tikzpicture}[scale=5,tdplot_main_coords]
    ...
    \tdplotdrawarc[thin,dashed,tdplot_rotated_coords,color=gray,opacity=0.5]{(0,0,0)}{\rvec}{0}{180}{anchor=east,color=gray}{}
    \tdplotdrawarc[thin,tdplot_rotated_coords,color=gray,opacity=0.5]{(0,0,0)}{\rvec}{0}{-180}{anchor=east,color=gray}{}

    \draw[tdplot_rotated_coords,color=gray, opacity=0.5,dashed] (0,0,0) -- ({\rvec*cos(\longascnode)},{\rvec*sin(\longascnode)},0) {node[anchor=north east]{$\ascnode$}};
...
% 		        {\thetaJLvec}{anchor=south east}{$\theta_{JL}$}
    ...
    \tdplotdrawarc[thick,tdplot_rotated_coords,->,dashed,NavyBlue]{(0,0,0)}{\orbitl}{\longascnode+58}{\orbphase - 5}{}{}
    \tdplotdrawarc[thick,tdplot_rotated_coords,|-,dashed,NavyBlue]{(0,0,0)}{\orbitl}{\longascnode+58}{\orbphase - 5}{}{}
    \tdplotdrawarc[thin,tdplot_rotated_coords,dashed,NavyBlue]{(0,0,0)}{\orbitl}{0}{85}{}{}
    %\tdplotdrawarc[thick,tdplot_rotated_coords,->,dashed,NavyBlue]{(0,0,0)}{\orbitl}{-180}{-270}{}{}

    \tdplotdrawarc[thin,dashed,tdplot_rotated_coords,color=NavyBlue]{(0,0,0)}{\rvec}{0}{180}{anchor=east,color=NavyBlue}{}
    ...
    \draw[thick,tdplot_rotated_coords,->,dashed,color=NavyBlue] (0,0,0) -- ({\psil*cos(\orbphase)},{\psil*sin(\orbphase)},0) {node[anchor=east]{$\hat{x}_L$}};
    \draw[thick,tdplot_rotated_coords,->,dashed,color=NavyBlue] (0,0,0) -- ({\psil*cos(\orbphase+90)},{\psil*sin(\orbphase+90)},0) {node[anchor=north]{$\hat{y}_L$}};
