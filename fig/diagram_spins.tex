...
\begin{tikzpicture}[scale=5,tdplot_main_coords]
    ...
    \draw[tdplot_rotated_coords,color=gray, opacity=0.5] (0,0,0) -- ({\rvec*cos(\longascnode)},{\rvec*sin(\longascnode)},0) {node[anchor=south]{$\ascnode$}};
...
% 		        {\thetaJLvec}{anchor=south east}{$\theta_{JL}$}
    ...
    \tdplotdrawarc[NavyBlue,thick,tdplot_rotated_coords]{(0,0,0)}{\orbitl}{0}{-94}{anchor=east,text height=-50pt}{$\phi_{\rm orb}$}
    \tdplotdrawarc[thick,tdplot_rotated_coords,->,dashed,NavyBlue]{(0,0,0)}{\orbitl}{\longascnode+58+90}{\orbphase - 5}{}{}
