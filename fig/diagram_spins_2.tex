...
\begin{tikzpicture}[scale=5,tdplot_main_coords]
    ...
    %\tdplotdrawarc[fill=gray,opacity=0.2]{(0,0,0)}{\discrad}{0}{90}{anchor=east,}{}
    %\draw[fill=gray!30] (0,0) -- (\discrad,0) arc[start angle=0, end angle=360,radius=\discrad] -- (0,0);
...
%    \draw[thick,->,color=black] (O) -- (Pp) node[anchor=west]{$\hat{k}$};

    \tdplotsetthetaplanecoords{\phiNvec}
		%\tdplotdrawarc[tdplot_rotated_coords,color=gray]{(0,0,0)}{0.5}{0}{\thetaJNvec}{anchor=south west}{}

    \tdplotsetrotatedcoords{\phiNvec}{\thetaJNvec}{-90}
    \tdplotdrawarc[thin,dashed,tdplot_rotated_coords,color=black,opacity=0.5]{(0,0,0)}{\rvec}{0}{180}{anchor=east,color=black}{}
    \tdplotdrawarc[thin,tdplot_rotated_coords,color=black]{(0,0,0)}{\rvec}{0}{-180}{anchor=east,color=black}{}

    \draw[thick,tdplot_rotated_coords,->,color=NavyBlue] (0,0,0) -- ({\rvec*cos(\longascnode)},{\rvec*sin(\longascnode)},0) {node[anchor=south]{$\ascnode$}};
...
% 		        {\thetaJLvec}{anchor=south east}{$\theta_{JL}$}
    ...
    % \draw[thick,tdplot_rotated_coords,->, NavyBlue, opacity=1] (0,0,0) -- (0,0,\wfl) node[anchor=south east]{$\hat{L}$};
...
%    \draw[thick,dotted, color=NavyBlue, opacity=0.5] (L) -- (Lxy);
    ...
    \draw[thin,tdplot_rotated_coords,NavyBlue,opacity=0.2] (\wfl,0,0) -- (-\wfl,0,0) node[anchor=north west]{};

    \tdplotdrawarc[dashed,tdplot_rotated_coords,color=NavyBlue]{(0,0,0)}{\rvec}{0}{180}{anchor=east,color=NavyBlue}{}
    \tdplotdrawarc[tdplot_rotated_coords,color=NavyBlue]{(0,0,0)}{\rvec}{0}{-180}{anchor=east,color=NavyBlue}{}

    \tdplotdrawarc[thin,dashed,tdplot_rotated_coords,color=NavyBlue,opacity=0.5]{(0,0,0)}{\orbitl}{0}{180}{anchor=east,color=NavyBlue}{}

    \tdplotdrawarc[thin,tdplot_rotated_coords,color=NavyBlue,opacity=0.5]{(0,0,0)}{\orbitl}{0}{-180}{}{}
    \tdplotdrawarc[thick,tdplot_rotated_coords]{(0,0,0)}{\orbitl}{0}{-94}{anchor=south}{$\phi_{\rm orb}$}
    \tdplotdrawarc[thick,tdplot_rotated_coords,->,dashed,black]{(0,0,0)}{\orbitl}{\longascnode+58+90}{\orbphase - 5}{}{}

    \draw[thick,tdplot_rotated_coords,->,dashed,color=NavyBlue,opacity=0.7] (0,0,0) -- ({\psil*cos(\orbphase)},{\psil*sin(\orbphase)},0) {node[anchor=east]{$\hat{x}_L$}};
    \draw[thick,tdplot_rotated_coords,->,dashed,color=NavyBlue,opacity=0.7] (0,0,0) -- ({\psil*cos(\orbphase+90)},{\psil*sin(\orbphase+90)},0) {node[anchor=north]{$\hat{y}_L$}};

    \draw[thin,tdplot_rotated_coords,-,dashed,opacity=0] (0,0,0) -- ({\orbitl*cos(\orbphase)},{\orbitl*sin(\orbphase)},0) {node[shape=circle,fill=black, scale=0.7,opacity=1]{} node[anchor=south east,color=black,opacity=1]{$m_1$}};

    %\draw[thin,tdplot_rotated_coords,-] (0,0,0) -- ({\psil*cos(\orbphase+180)},{\psil*sin(\orbphase+180)},0) {node[anchor=north west]{$\hat{y}_L$}};
    ...
    \draw[thick,->,color=gray] (0,0,0) -- (0,0,\rvec) node[anchor=south]{$\hat{J}$};

    \draw[thick,->,gray] (O) -- ({\discrad*cos(90-\phiNvec)},{-\discrad*sin(90-\phiNvec)},0) node[anchor=north]{$\hat{x}_J$};
    \draw[thick,->,gray] (O) -- ({\discrad*cos(\phiNvec)},{\discrad*sin(\phiNvec)},0) node[anchor=north]{$\hat{y}_J$};
