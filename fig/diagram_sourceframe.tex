...
\begin{tikzpicture}[scale=5,tdplot_main_coords]
    ...
    \draw[-,color=blue,dotted] (O) -- (P) node[]{};
    \draw[-stealth,color=white,opacity=0] (O) -- (P) node[black,opacity=1,fill=white,rotate=45]{$\lateraleye$};
    ...
    \draw[thick,tdplot_rotated_coords,->, blue, opacity=1] (0,0,0)
    ...
    \draw[-,thick,dotted,color=black,opacity=1,tdplot_rotated_coords] (0,0,0) -- %
        (0,-\psil,0) node[anchor=south]{$\hat{L}'$};

    \draw[-stealth,thick,color=blue,opacity=0.25,tdplot_rotated_coords] (0,0,0) -- %
    ...
    \tdplotdrawarc[tdplot_rotated_coords,color=blue,opacity=0.25]{(0,0,0)}{0.25*\psil}{-\longascnode}%
        {-\longascnode+\psivec}{anchor=south}{$\psi$}
    ...
    \draw[-stealth,thick, dashed,opacity=0.7,color=blue,tdplot_rotated_coords] (0,0,0) -- %
    ...
    \tdplotdrawarc[tdplot_rotated_coords,color=blue]{(0,0,0)}{0.5*\psil}{0}%
        {-\longascnode}{anchor=east,color=blue}{$\Omega$}
